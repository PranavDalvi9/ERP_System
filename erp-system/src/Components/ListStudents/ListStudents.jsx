...
// var filterData ;
    ...
    // useEffect(() => {
    //     if(name1.length > 0){
    //         filterData = name1.length === 0 ? filterDataOne : filterDataOne.filter((e) => e.name.toLowerCase().includes(name1.toLowerCase()))
    //         // console.log("name fill ",name1.length ,filterData )
    //     }
    //     if(roll1.length > 0){
